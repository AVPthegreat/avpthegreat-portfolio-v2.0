...
const Hero = ({ portraitSrc }) => {
  return (
    <section
      id="bio"
      className="min-w-[100vw] h-screen flex flex-col justify-between px-8 pb-8 relative overflow-hidden snap-start"
    >
      {/* Main Text */}
      ...
      <div className="flex justify-between items-end mt-20">
        ...
        <div className="flex flex-col items-center gap-4">
          {/* Portrait Image */}
          <div className="w-80 h-80 bg-gray-200 rounded-lg overflow-hidden shadow-lg transform -rotate-2 hover:rotate-10 transition-transform duration-500">
            {portraitSrc && (
              <img
                src={portraitSrc}
                alt="Portrait"
